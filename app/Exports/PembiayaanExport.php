    ...
    */
    ...
    public function collection()
    {
        if ($this->status === 'current') {
            ...
            $query = DB::table('pembiayaan')
                ...
                ->leftJoin('sumber_dana', 'anggota.source_income', '=', 'sumber_dana.id')
                ...
                ->select([
                    ...
                    DB::raw('MAX(sumber_dana.sumber_dana) as sumber_dana'),
    ...
    $query = DB::table('data_loan')
        ...
        ->select([
            ...
            DB::raw('MAX(sumber_dana.sumber) as sumber_dana'),
