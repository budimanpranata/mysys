                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="unit" id="unit" value="{{ Auth()->user()->id }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="cif" id="cif" value="001250218" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="ktp" id="nikInput" placeholder="Masukkan No Identitas" required>
                                        {{-- <input type="text" class="form-control" name="ktp" id="ktp" placeholder="Masukkan No Identitas" required> --}}
        
                                        
                                        <div class="input-group-append">
                                            <a href="#" class="btn btn-primary" onclick="searchByNik()" id="nikInput">
