    ...
    <table class="data-table">
        ...
        <tbody>
            @php
                ...
                $saldo = 0;
            @endphp
            @foreach ($mutasiSimpanan as $mutasi)
                @php
                ...
                <tr>
                    <td>{{ $no++ }}</td>
                    <td style="text-align: left">{{ date('d-m-Y', strtotime($mutasi->buss_date)) }}</td>
                    <td>{{ $mutasi->kode_transaksi }}</td>
                    <td>{{ $mutasi->ket }}</td>
                    <td style="text-align: center">{{ $mutasi->type }}</td>
